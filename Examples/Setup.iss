...
;
; $jrsoftware: ispack/setup.iss,v 1.69 2009/03/18 23:41:02 mlaan Exp $

[Setup]
AppName=Inno Setup QuickStart Pack
AppId=Inno Setup 5
AppVerName={cm:NameAndVersion,Inno Setup QuickStart Pack,5.2.4}
AppVersion=5.2.4
...
begin
  ...
  if ISTool then begin
    ...
    URL := 'http://downloads.sourceforge.net/istool/istool-5.2.1.exe';
